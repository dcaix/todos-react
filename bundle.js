...
/******/ 	var hotCurrentHash = "92e4aa50e711cfed274f"; // eslint-disable-line no-unused-vars
...
_reactDom2.default.render(_react2.default.createElement(_Box2.default, null), document.getElementById('main'));
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(42),B=__webpack_require__(20),C=__webpack_require__(7),ba=__webpack_require__(43),da=__webpack_require__(44),ea=__webpack_require__(45),fa=__webpack_require__(46),ia=__webpack_require__(47),D=__webpack_require__(21);
...
var Content = function (_React$Component) {
  ...
  function Content() {
    ...
    _this.addTask = function (task) {
      _this.state.list.push(task);
      _this.setState({});
      // // 还需要将数据存储到localStorage中
      // localStorage.setItem('tasks', JSON.stringify(this.state.list));
    };

    _this.delTask = function (id) {
      _this.state.list = _this.state.list.filter(function (item) {
        return item.id != id;
      });
      _this.setState({});
      // // 还需要将数据存储到localStorage中
    ...
    _this.changeFlag = function (flag) {
      _this.setState({
        flag: flag
      });
    };

    _this.clearCompletedTask = function () {
      _this.state.list = _this.state.list.filter(function (item) {
  ...
  (0, _createClass3.default)(Content, [{
    ...
    value: function componentWillUpdate() {
      // 还需要将数据存储到localStorage中
      localStorage.setItem('tasks', (0, _stringify2.default)(this.state.list));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'section',
        { className: 'todoapp' },
        _react2.default.createElement(_Add2.default, { addTask: this.addTask }),
        _react2.default.createElement(_List2.default, { tasklist: this.state.list, flag: this.state.flag, delTask: this.delTask, update: this.update }),
        this.state.list.length ? _react2.default.createElement(_Footer2.default, { flag: this.state.flag, left: this.state.list.filter(function (item) {
            return !item.isCompleted;
          }).length, all: this.state.list.length, clearCompletedTask: this.clearCompletedTask, changeFlag: this.changeFlag }) : ''
      );
    }
  }]);
  return Content;
...
var Add = function (_React$Component) {
  ...
  function Add() {
    ...
    _this.taskNameChange = function (e) {
      _this.setState({
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { action: '', onSubmit: function onSubmit(e) {
              ...
              e.preventDefault();
              // 将数据传递给父级组件
              var task = { name: _this2.state.taskname, id: Math.random(), isCompleted: false };
          ...
          _react2.default.createElement('input', { className: 'new-todo', value: this.state.taskname, onChange: this.taskNameChange, placeholder: 'What needs to be done?', autoFocus: true })
        )
      );
    }
  }]);
...
var List = function (_React$Component) {
  ...
  // genClass=( item )=>{
  //   return (item.isCompleted?'completed ':'')+(item.id == this.state.eid? 'editing':'') 
  // }
  ...
  (0, _createClass3.default)(List, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { className: "main" },
        function () {
          var left = _this2.props.tasklist.filter(function (item) {
            return !item.isCompleted;
          });

          return _react2.default.createElement("input", { id: "toggle-all", className: "toggle-all", type: "checkbox", onChange: function onChange() {
              _this2.props.tasklist.map(function (item) {
        ...
        _react2.default.createElement(
          "ul",
          { className: "todo-list" },
          this.props.tasklist.map(function (item, i) {
            if (_this2.props.flag === 'Active' && item.isCompleted) {
              return '';
            }
            if (_this2.props.flag === 'Completed' && !item.isCompleted) {
              return '';
            }
            return _react2.default.createElement(
              "li",
              { key: item.id, className: (item.isCompleted ? 'completed ' : '') + (item.id == _this2.state.eid ? 'editing' : ''), onDoubleClick: function onDoubleClick() {
                  // 让内容可以编辑
                  _this2.setState({
                    eid: item.id
                  }, function () {
              ...
              _react2.default.createElement(
                "div",
                { className: "view" },
                _react2.default.createElement("input", { className: "toggle", type: "checkbox", checked: item.isCompleted, onChange: function onChange() {
                    item.isCompleted = !item.isCompleted;
                    // 调用父组件的setState方法
                    _this2.props.update();
                  } }),
                ...
                _react2.default.createElement("button", { className: "destroy", onClick: function onClick() {
                    _this2.props.delTask(item.id);
                  } })
              ),
              _react2.default.createElement("input", { ref: item.id, className: "edit", onChange: function onChange(e) {
                  item.name = e.target.value;
                  // 调用父组件的setState方法
                  _this2.props.update();
                }, value: item.name, onBlur: function onBlur() {
                  _this2.setState({
                    eid: -1
                  });
                } })
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { className: this.props.flag === 'All' ? "selected" : '', href: "#/", onClick: function onClick() {
                  _this2.props.changeFlag('All');
                } },
              "All"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { className: this.props.flag === 'Active' ? "selected" : '', href: "#/active", onClick: function onClick() {
                  _this2.props.changeFlag('Active');
                } },
              "Active"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { className: this.props.flag === 'Completed' ? "selected" : '', href: "#/completed", onClick: function onClick() {
                  _this2.props.changeFlag('Completed');
                } },
              "Completed"
            )
          )
        ),
        this.props.all != this.props.left ? _react2.default.createElement(
          "button",
          { className: "clear-completed", onClick: function onClick() {
              _this2.props.clearCompletedTask();
            } },
          "Clear completed"
        ) : ''
      );
